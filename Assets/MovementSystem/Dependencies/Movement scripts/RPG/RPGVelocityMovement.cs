...
public class RPGVelocityMovement : MovementTypeController
{
    ...
    public RPGVelocityMovement(MovementController movementController) : base(movementController)
    {
    ...
    private void Move()
    {
        _rigidbody.velocity = (new Vector3(((MovementController.GetMoveXAxis * _speed) * 200) * Time.fixedDeltaTime, 0,
